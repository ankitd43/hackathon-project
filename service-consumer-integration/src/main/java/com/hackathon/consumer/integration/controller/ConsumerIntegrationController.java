...
//		}
	...
	@GetMapping(value ="/check-job-status",consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.ALL_VALUE)
	public ResponseEntity<Object> checkJobStatus(@RequestParam(required = true) Long jobId , HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse ){
		logger.info("Enter into login()");
		HttpStatus httpStatus = HttpStatus.OK;
		ConsumerDetailResponse consumerDetailResponse = null;
//		try {
